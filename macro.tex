...
\usepackage[paperwidth=16.9cm,
paperheight=24cm,hmargin={1.5cm,1.2cm},vmargin={1.5cm,2.2cm}]{geometry}
...
\usepackage[center,labelfont=bf,font=footnotesize]{caption}
...
\renewcommand{\cftsubsubsecnumwidth}{4mm}
...
\newcommand{\ChapterStar}[1]{
	...
	\titleformat{\chapter}[display]
		{\normalfont\huge\bfseries}{\chaptertitlename\
		\thechapter}{20pt}{\vspace{-80pt}\Huge} 
		\chapter*{#1}
	\pagestyle{chapitre}}
...
\usepackage[%
%###
refsection=chapter, isbn=false,bibencoding=utf8,
...
\newcommand{\nomwithdim}[5]{\nomenclature[#1]{#2}%
{\nomdescr{#3}\parbox[t]{3cm}{\centering #4}\parbox[t]{2cm}{\RaggedLeft #5}}}
\newcommand{\nomLarge}[3]{\nomenclature[#1]{#2}%
{\RaggedLeft #3}}
\newcommand{\nomDivers}[4]{\nomenclature[#1]{#2}%
{\parbox[t]{8cm}{\RaggedRight #3}\parbox[t]{7cm}{\RaggedRight #4}}}
