...
calcule en fonction de la pulsation cyclotronique et de la vitesse $v$ de la
particule :
...
=v\indice{\alpha}\left[\left(\frac{eT_{\alpha}}{m_{\alpha}}\right)^{\text{\textonehalf}}\right]
\end{equation}
...
\begin{equation}
\mathbf{v}_F=\frac{\mathbf{F}\times\mathbf{B}}{q_\alpha B^2}
\end{equation}

Si la force $F$ est indépendante de la charge de la particule, cette vitesse de
dérive induira un courant $\mathbf j_F=en(\mathbf v\indice{F_i}-\mathbf
v\indice{F_e})$. Dans un plasma, où l'anisotropie du champ magnétique est
souvent utilisée pour contrôler et limiter le déplacement des particules, 
l'apparition de vitesse de dérives peut alors entraîner des
