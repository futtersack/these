...
\label{Physique du transport magnétisé}
\begin{refsection}
...
approximations\parencite{Approximation deux termes, Approche homogène, approche
non-locale}. De plus, quand une espèce est suffisamment collisionnelle, sa
...
de Maxwell, l'équation de Boltzmann s'intègre donc facilement dans l'espace des
...
l'équation de Boltzmann multipliée par une certaine puissance de $\mathbf v$
