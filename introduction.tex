...
dominant.} semblable au paramètre plasma \eqrefp{1-paramPlasma}.
...
fonction de la masse de la particule, cette vitesse de dérive induira un courant $\mathbf
...
particules, l'apparition de vitesse de dérives peut alors entraîner des
effets non désirables par le développement de comportements non-linéaires
complexes.

\subsection{Les gaines électrostatiques}
\subsubsection{Physique de la gaine}
La gaine de Debye (ou gaine électrostatique) est une structure non
neutre qui apparait le long des parois, des électrodes ou de tout obstacle
matériel en contact avec le plasma. A l'interface plasma-solide, les
électrons, généralement plus rapides que les ions du fait de leur faible masse
et de leur température, polarisent négativement la surface du matériau,
relativement au plasma. 
Suite à l'augmentation progressive de ce potentiel, qui attire de plus en plus
les ions tout en repoussant les électrons, une région de densité ionique
supérieure, que l'on appelle gaine, se forme en périphérie du plasma (voir
figure~\ref{1-gaine}). La taille de cette gaine est de l'ordre de la longueur de Debye
$\lambda_D$, et est donc fortement dépendante de la densité plasma. 

\begin{figure}[htbp]
\centering
\includegraphics[height=80mm,width=80mm]{figures/sheath1.jpg}{\caption{Séparation
...
ionique est égale à la vitesse de Bohm $C_s$\parencite{Rax}.}\label{1-gaine}}
\end{figure}
...
\end{equation}
 ...
 moyenne du plasma. Dans la limite où $\lambda_D\ll L$ l'équation de
 poisson permet de distinguer les deux régions :

 \begin{itemize}
   \item La gaine, fine épaisseur de peau du plasma de taille caractérisique
   $\lambda_D$, où l'électroneutralité est rompue et où se développe un fort
   gradient de potentiel ($d\Phi/d\xi\sim 1/\lambda_D$)
   \item Le reste du plasma, de taille caractéristique $L$, qui satisfait
   à l'hypothèse de quasineutralité dans la mesure où le potentiel varie en
   $d\Phi/d\xi\sim1/L$
 \end{itemize}

L'étude de la transition plasma-gaine donne lieu à l'énoncé du critère de
Bohm \parencite{Stangeby}, qui impose la vitesse ionique en entrée de
gaine, $C_s$, communément appelée vitesse de Bohm ou encore vitesse acoustique
ionique\footnote{la deuxième appellation provient de la similitude entre la
transition subsonique-supersonique qui s'observe dans les gaz neutres. Les ondes
acoustiques, reliées aux surpressions et aux souspressions, se propagent dans un
plasma par le champ électrique. L'élasticité du plasma est alors due à la
température électronique $T_\text{e}$ et à l'inertie ionique.} :

\begin{equation}
C_\text{s}=\sqrt{\frac{q_\text{i} (T_\text{e}+T_\text{i})}{m_\text{i}}}
\end{equation}
