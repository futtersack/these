...
de l'espace des phases à un instant $t$. 
...
L'approche fluide consiste ainsi à supposer à étudier l'évolution de 
pour chaque espèce,
...
$C_{\alpha\beta}$ étant un taux caractéristique correspondant au phénomène
collisionnel enntre $\alpha$ et $\beta$.


En effet sur ces échelles de temps, les fonctions de
distribution en vitesses se relaxent vers maxwellienne locale vers des
distributions de Maxwell-Boltzmann, prenant souvent\footnote{Quand le plasma possède deux populations d'une même espèce à des énergies très différentes, la distribution en vitesse n'est pas maxwellienne mais peut se décomposer en une somme de maxwellienne.} la forme d' déformée :
