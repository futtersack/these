...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{figures/1-zoologie.png}{\caption{Classification
...
Lorsque le champ magnétique généré par les courants du plasma est
assez faible, comme dans les sources d'ions, il est commun de
...
pour caractériser une maxwellienne dans le centre de masse, la vitesse moyenne
$\left<|\mathbf v-\mathbf u|\right>$ et la vitesse quadratique moyenne
$\sqrt{\left<|\mathbf v-\mathbf u|\puissance{2}\right>}$ :
$$
	\left<|\mathbf v-\mathbf u|\right>=\sqrt{\frac{8T}{\pi m}} \;\;\;\;\text{et}\;\;\;\; 
	\left<|\mathbf v-\mathbf u|\puissance{2}\right>=\frac{3T}{m}
$$ 
