...
auront une vitesse thermique d'environ \unit{10}{\kilo\meter}.$s\puissance{-1}$,
du fait de la différence de masse.
...
Research Council \cite{national1995Plasma}}\label{zoologie}}
\end{figure}
...
charge et $(\mathbf E,\mathbf B)$ le champ électromagnétique. Elle se décompose
...
collisionnelle d'un électron~{\cite{rax2005physique}}.}\label{1-collisions}}
\end{figure}
\begin{equation}
