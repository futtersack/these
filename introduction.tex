...
\label{1-collisionfreq}
	\nu_{\alpha s}=\left<\sigma_{\alpha s}
\sigma_{in} n_{n} v_{i}\right>
\end{equation} 
\begin{equation}
\label{1-coefTaux}
	k_{\alpha s}=\left<\sigma_{\alpha s}
v_r\right>
\end{equation} 
le coefficient de collision/réaction associé avec
$v_r=(\mathbf u_s-\mathbf u_\alpha)$ la vitesse relative des deux fluides.
