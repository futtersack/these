...
périphérie du plasma confiné, ie. qui se situe entre la séparatrice et les
parois internes du tore~\ref{SOL}. Dans cette région, les particules ne sont
plus confinées car les lignes de champ interceptent un obstacle matériel
construit spécifiquement pour supporter les flux de matière et de chaleur
sortant du plasma de c\oe ur (un limiteur ou un divertor).

Comprendre l'origine et la nature du transport dans la SOL est l'un des enjeux
majeurs dans la réussite de la fusion par confinement magnétique, et ce pour
deux raisons essentielles : 
\begin{itemize}
  \item d'une part 
\end{itemize} les lignes de champs magnétiques
interceptent l faible niveau de confinement Le transport transverse est loin d'être diffusif, le transport turbulent brise le confinement. zonal flow
retroagit sur la turbulence Ces dispositif qui permet de contrôler la forme du
plasma et d'extraire la chaleur produite par le plasma de c\oe ur.
\begin{figure}[!htbp]
    \centering
