...
brisure de la quasineutralité. Quelques considérations dans le cadre d'une
description unidimensionnelle du problème permettent une vision simple : A
l'intérieur de la gaine, afin de maintenir la décroissance du potentiel jusqu'à
la paroi, la densité ionique doit diminuer moins rapidement que
la densité d'électrons. En applicant la loi de conservation d'énergie entre
l'entrée de la gaine (où les densités sont égales) et la paroi, on trouve le
critère universel dérivé par Bohm :

\begin{equation}
	v_\text{i}|_{\xi=x_s}\geq C_\text{s}=\sqrt{\frac{eT_\text{e}}{m_\text{i}}}
\end{equation}
\end{equation}
