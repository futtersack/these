...
celle d'un état gazeux partiellement ou totalement ionisé, ie. possédant une
population d'électrons et d'ions, possiblement de différentes espèces. Ces populations de
charges libres, qui sont sensibles aux forces
électromagnétiques, permettent alors le transport de courant et influencent
fortement le comportement global du plasma, provoquant l'apparitions de
...
applications : des dispositifs d'affichage et d'éclairage au traitement et à la
gravure de matériaux, de la propulsion spatiale jusqu'à la fusion
thermonucléaire contrôlée, sont autant d'exemples pour lequels la maîtrise des plasmas est essentielle.

L'étude du comportement des plasmas est une problématique au c\oe ur de
projets de recherche ambitieux tels que la fusion thermonucléaire contrôlée. 
...
Ce premier chapitre rappelle les bases théoriques nécéssaires à la compréhension
...
Le critère de Bohm pour un plasma multi-espèce a été dérivé par Riemann
\parencite{Riemann95}, il prend la forme :
...
$$\mathcal{S}_\alpha=\sum_s N_s n_{\alpha}n_{s}k_{\alpha s}$$ où $s$ denote les
autres espèces présentes dans le plasma, $N$ est le nombre de particules créées lors
...
où $\nu_{{iz}}=\mathcal{S}_\alpha/n_\alpha$ provient de la substitution de
l'équation de continuité et caractérise la perte effective de quantité de mouvement
...
contribution de l'énergie dirigée $\mathcal{U}_{\alpha}=m_\alpha n_\alpha
...
$(2n_\alpha\nu_\alpha+\mathcal{S}_\alpha)\mathcal{U}_\alpha$ apparaît distinctement
comme une production ou une perte de chaleur conséquente du travail de la force de traînée générée par
...
k}\frac{\partial u_{\alpha j}}{\partial{x_k}}+ \frac{3}{2}\mathcal{S}_\alpha
eT_\alpha = {Q_\alpha}+(2n_\alpha\nu_\alpha+\mathcal{S}_\alpha)\mathcal{U}_\alpha
\end{equation}
...
j}}{\partial{x_k}}+ \frac{5}{2}\mathcal{S}_\alpha eT_\alpha =
