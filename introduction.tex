...
cyclotroniques sont grandes devant les fréquences caractéristiques du transport
 ...
 Avant de développer cette méthode, et pour introduire les plasmas
 fortement magnétisés de la Scrape-Of-Layer que nous étudions dans les chapitres
 suivant, il est nécéssaire de faire une petite apparté sur le
 principe de la fusion par confinement magnétique et sur les problématiques qui
 lui sont associées.
...
disperser le plasma, celui-ci doit être confiné par des forces extérieures pour atteindre un
équilibre favorable à la réalisation de réactions de fusion.

Pour que la fusion puisse être énergétiquement rentable, il est nécessaire
que l’énergie produite soit supérieure à la somme de l’énergie perdue hors du
système et de celle consommée par les réactions. Cette contrainte s'exprime sous
la forme $nT_i\tau_E>f(Q)$ où $n$ est la densité du
plasma, $T_i$ la température ionique et $\tau_E$ un temps caractéristique de relaxation
de l'énergie en l'absence de toute source de chauffage. En pratique, on estime 

La problématique de la production d'énergie par fusion
