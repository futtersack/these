...
L'étude de phénomènes et de processus physiques s'effectue généralement en
combinant expérimentation et développement théorique.  La description fluide, en
supposant une cohésion macroscopique de l'ensemble des particules, forme un modèle de base pour étudier l En supposant le tenseur
de pression isotrope, ie.
