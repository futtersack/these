...
prenant le produit vectoriel de l'equation du mouvement et du champ magnétique :
...
magnétique est souvent utilisée pour contrôler et limiter le déplacement des particules, l'apparition de vitesse de dérives peut alors entraîner des
...
\includegraphics[width=0.8\textwidth]{figures/mouvementCyclotron.png}
{\caption{Mouvement cyclotronique des particules autour des lignes de champ
magnétique.}\label{1-gaine}}
\end{figure}

L'apparition de la gaine est fondamentalement relié à l'établissement de la
quasineutralité et de la diffusion ambipolaire qui s'opère lors de la formation
d'un plasma. Ce phénomène sera détaillé dans la suite du chapitre
(§\ref{1-transportAmbipolaire}, mais nous pouvons d'ores et déjà introduire
quelques idées. La taille gaine, de l'ordre de la longueur
de Debye $\lambda\indice{D}$, diminue le champ électrique
généré par la charge d'espace positive est suffisement imporant pour écranter le potentiel de la surface.

Comme $\lambda\indice{D}$ est 

Le phénomène de 
Ce phénomène, régit par les mêmes échelles que l

 de
atteindre un équilibre dans lequel assurant une égalité des flux tombant à la surface.
