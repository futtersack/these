...
Elle se décompose principalement sur deux
échelles de temps :
...
en ne gardant que les dimensions spatiales et temporelle du système : c'est
l'approche fluide.
...
$$\mathcal{S}_\alpha=\sum_s N_s n_{\alpha}n_{s}k_{\alpha s}$$ où $s$ dénote les
...
froids, c'est les collisions avec le gaz au repos qui sont dominantes. La force thermique peut être
...
efficace de transfert de quantité de mouvement. En remplaçant les expressions du
