\Chapter{Introduction}
	...
	\lipsum{50}
		...
		\section{Les gaines électrostatiques}
			...
			du fait de la plus grande vitesse des électrons par rapport à celle des ions d'un facteur au moins égal à même
			température au ratio des masses $\sqrt{m_i/m_e}$ Ces structures se forment
			ont une taille de l'ordre de grandeur de la longueur de Debye $\lambda_D$
