...
Ce chapitre est consacré à la construction d'un modèle fluide 2D pour les
...
Dans cette partie, nous proposons un nouveau modèle pour décrire le transport
magnétisé dans les plasmas froids. 
\subsection{Modèle de dérive-diffusion magnétisé}
