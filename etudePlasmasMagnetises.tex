...
d'hydrogène a une densité de 3 10$\puissance{14}$ m$\puissance{-3}$ et sa température, assez
homogène, est de 11eV. Ajoutons maintenant un champ magnétique : au fur et à mesure de la montée en
intensité, on peut repérer 6 modes de fonctionnement.
...
apparaissent, tournant à une vitesse angulaire $\Omega_r$ qui varie de 1 à 2
10$\puissance{6}\,\text{rad.s}\puissance{-1}$ sur une orbite de rayon
approximativement égale au rayon de Larmor électronique, qui devient inférieur
à 5cm. La température maximale commence à
osciller\footnote{A B=7.5G, la fréquence cyclotronique électronique est égale à 1.3
10$\puissance{8}\,\text{s}\puissance{-1}$, très proche de la fréquence de
collision des électrons. Le maximum de température atteint son plus haut taux de
fluctuation.} et augmente plus modérément.
...
A partir de 18G, le plasma devient extrêmement instable, comme illustré
...
très rapidement par une sorte d'explosion. La fréquence du phénomène est
d'environ 12~kHz, variant peu de 18G à 35G.
...
\begin{figure}[htbp]
  \centering
    ...
    différents. La densité part de 2 10$\puissance{15}$
    ~\subref{4-CybeleVarMag4}~, augmente pendant un durée $t\sim
    \subref{4-CybeleVarMag5}~ et de température \subref{4-CybeleVarMag6}}
    \label{4-CybeleVarMag-2}
\end{figure}

La figure~\ref{4-CybeleVarMag8} montre la forme du plasma à 35G, qui se
stabilise. La température moyenne des électrons redescend à une quinzaine
d'électron-volt, faisant diminuant le rayon de Larmor ionique jusqu'à une
longueur de l'ordre de la dizaine de centimètres, qui devient donc inférieure à
...
et la densité oscillent fortement et un mode poloïdal prend de plus en plus
d'importance.

\subsubsection{de 70G à 100G}
