...
Le dernier cas de test est consacré à la configuration hautement magnétisée de
la SOL. Le premier objectif est toujours de vérifier la validité des solutions
calculées par MAGNIS ; nous les comparons pour cela avec les résultats de
TOKAM dans sa version avec conditions aux limites dans la direction radiale.
...
{\caption{Le domaine de simulation correspond à une petite partie de la SOL,
dans le plan poloïdal médian. La source, en orange représente le flux de
particules traversant la séparatrice et entrant dans la SOL. La taille du domaine de
simulation est prise à 256x256 rayons de Larmor ioniques, soit
0.02x0.02m\textsuperscript{2}}, et la direction poloïdale est périodique.
