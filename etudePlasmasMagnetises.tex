...
occupé par des cathodes filamentaires qui, polarisées négativement à -60V, libèrent des
électrons primaires pour créer le plasma. Celui-ci est ensuite confiné dans un champ
magnétique vertical et uniforme, généré par deux bobines sur les côtés de la
source et dont l'intensité peut varier de 0G à 160G.
\begin{figure}[!h]
  \centering
...
\end{figure}	
Cybele opère enfin avec un gaz d'hydrogène à très basse pression, $P\simeq 2$
mTorr, condition requise pour réduire la perte d'ions négatifs.

Les mesures expérimentales donne une densité au centre du plasma d'environ

\begin{figure}[htbp]
  \centering
    \includegraphics[height=8cm]{figures/4-CybeleFourierSignal.jpg}
