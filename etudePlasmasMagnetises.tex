...
figure\ref{4-PegasesVaguesIoniques}. A intervalles régulières, des vagues de
surdensités traversent le filtre magnétique à très grande vitesse dans la
direction perpendiculaire au front de densité. Cette instabilité est directement
reliée au terme inertiel d'advection de la vitesse ionique (il
suffit en effet de ne plus le prendre en compte dans le modèle pour faire
totalement disparaître le phénomène). 

Sans bias et à une pression de gaz de 1mTorr, les fronts de densité
apparaissent à une fréquence d'environ 120kHz et se déplacent à une vitesse de
2.2 km.s$\puissance{-1}$. proche de la vitesse acoustique ionique, fait
naturellement penser à la transition subsonique-supersonique qui advient dans les gaz classiques.
\begin{figure}[htbp] 
  \centering
    ...
    \caption{Cartes de densité\subref{4-PegasesCarteDensiteWave}~, de
...
\begin{figure}[htbp]
  \centering
    ...
    \includegraphics[height=7cm]{figures/4-PegasesCarteDensite512.eps}}
    \subfigure[]{\label{4-pegasesCarteTemp512}
    \includegraphics[height=7cm]{figures/4-PegasesCarteTemp512.eps}}
