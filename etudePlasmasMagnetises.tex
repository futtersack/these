...
\begin{figure}[!htbp]
    ...
    \includegraphics[height=0.38\textwidth]{figures/4-PegasesCarteDensiteBase.eps}}
    \subfigure[]{\label{4-PegasesCartePotentielBase}
    \includegraphics[height=0.38\textwidth]{figures/4-PegasesCartePotentielBase.eps}}
    \subfigure[]{\label{4-PegasesCarteTemperatureBase}
    \includegraphics[height=0.38\textwidth]{figures/4-PegasesCarteTemperatureBase.eps}}
...
\begin{figure}[!htbp]
  \centering
    ...
    \includegraphics[height=0.42\textwidth]{figures/4-PegasesCarteFluxIBase.eps}}
    \subfigure[]{\label{4-PegasesCarteFluxEBase}
    \includegraphics[height=0.42\textwidth]{figures/4-PegasesCarteFluxEBase.eps}}
    \caption{Densité de courant ionique \subref{4-PegasesCarteFluxIBase}
    et électronique \subref{4-PegasesCarteFluxEBase}. Le champ magnétique,
...
\begin{figure}[!htbp]
  \centering
    ...
    température \subref{4-pegasesCompMagTempProfile} pour trois intensités de
...
différents de 0 V, 10 V et 20 V appliqués à la grille d'extraction de la source. 
 ...
 \begin{figure}[!htbp]
	\centering
	\includegraphics[height=0.9\textheight]{figures/4-pegasesfluxElectronique.pdf}
...
\begin{figure}[!htbp] 
  \centering
    ...
    \includegraphics[height=0.42\textwidth]{figures/4-PegasesCarteDensiteWave.eps}}
    \subfigure[]{\label{4-PegasesCarteViSurTeVarBias}
    \includegraphics[height=0.42\textwidth]{figures/4-PegasesCarteViSurTeVarBias.eps}}
...
filtre, de densité équivalente à celle du plasma de la région d'ionisation.
  ...
  \centering
    ...
    \includegraphics[height=0.4\textwidth]{figures/4-PegasesCarteDensiteVarBias1.eps}}
    \subfigure[]{\label{4-PegasesCarteDensiteVarBias2}
    \includegraphics[height=0.4\textwidth]{figures/4-PegasesCarteDensiteVarBias2.eps}}
    \subfigure[]{\label{4-PegasesCarteDensiteVarBias3}
    \includegraphics[height=0.4\textwidth]{figures/4-PegasesCarteDensiteVarBias3.eps}}
...
ionique.
  ...
  \centering
    ...
    \includegraphics[height=0.42\textwidth]{figures/4-PegasesCarteDensiteVarBias5.eps}}
    \subfigure[]{\label{4-PegasesCarteDensiteVarBiasPeriod}
    \includegraphics[height=0.42\textwidth]{figures/4-PegasesCarteDensiteVarBiasPeriod.eps}}
...
\begin{figure}[!htb]
  \centering
    \includegraphics[width=0.8\textwidth]{figures/4-cybeleSchema.png}
...
\begin{figure}[!htbp]
  \centering
    ...
    \includegraphics[height=0.35\textwidth]{figures/4-CybeleExp.png}}
    \subfigure[]{\label{4-CybeleExp2}
    \includegraphics[height=0.35\textwidth]{figures/4-CybeleExp2.png}}
    \subfigure[]{\label{4-CybeleExp3}
    \includegraphics[height=0.35\textwidth]{figures/4-CybeleExp3.png}}
...
\begin{figure}[!htbp]
  \centering
    ...
    \includegraphics[height=0.4\textwidth]{figures/4-CybeleCarteDensiteMoy.eps}}
    \subfigure[]{\label{4-CybeleCartePotentielMoy}
    \includegraphics[height=0.4\textwidth]{figures/4-CybeleCartePotentielMoy.eps}}
    \subfigure[]{\label{4-CybeleCarteTemperatureMoy}
    \includegraphics[height=0.4\textwidth]{figures/4-CybeleCarteTemperatureMoy.eps}}
...
\begin{figure}[!htbp]
  \centering
    ...
    \includegraphics[height=0.4\textwidth]{figures/4-CybeleCarteDensiteBase.eps}}
    \subfigure[]{\label{4-CybeleCartePotentielBase}
    \includegraphics[height=0.4\textwidth]{figures/4-CybeleCartePotentielBase.eps}}
    \subfigure[]{\label{4-CybeleCarteTemperatureBase}
    \includegraphics[height=0.4\textwidth]{figures/4-CybeleCarteTemperatureBase.eps}}
...
\begin{figure}[!htbp]
  \centering
    ...
    \includegraphics[height=0.35\textwidth]{figures/4-CybeleProfileTempRadiale.eps}}
    \subfigure[]{\label{4-CybeleProfilsAzim}
    \includegraphics[height=0.35\textwidth]{figures/4-CybeleProfileTempPol.eps}}
...
\begin{figure}[!htbp]
  \centering
    ...
    \includegraphics[height=0.37\textwidth]{figures/4-CybeleCarteFluxIBase.eps}}
    \subfigure[]{\label{4-CybeleCarteFluxEBase}
    \includegraphics[height=0.37\textwidth]{figures/4-CybeleCarteFluxEBase.eps}}
...
\begin{figure}[!htb]
  \centering
    ...
    \includegraphics[height=0.4\textwidth]{figures/4-CybeleVarMag1.eps}}
    \subfigure[]{\label{4-CybeleVarMag2}
    \includegraphics[height=0.4\textwidth]{figures/4-CybeleVarMag2.eps}}
    \subfigure[]{\label{4-CybeleVarMag3}
    \includegraphics[height=0.4\textwidth]{figures/4-CybeleVarMag3.eps}}
...
\begin{figure}[htb]
  \centering
    ...
    \includegraphics[height=0.4\textwidth]{figures/4-CybeleVarMag4.eps}}
    \subfigure[]{\label{4-CybeleVarMag5}
    \includegraphics[height=0.4\textwidth]{figures/4-CybeleVarMag5.eps}}
    \subfigure[]{\label{4-CybeleVarMag6}
    \includegraphics[height=0.4\textwidth]{figures/4-CybeleVarMag6.eps}}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=0.38\textwidth]{figures/4-CybeleVarMag8.eps}
...
\begin{figure}[!htbp]
  \centering
    ...
    \includegraphics[height=0.4\textwidth]{figures/4-CybeleVarMag9.eps}}
    \subfigure[]{\label{4-CybeleVarMag10}
    \includegraphics[height=0.4\textwidth]{figures/4-CybeleVarMag10.eps}}
    \subfigure[]{\label{4-CybeleVarMag11}
    \includegraphics[height=0.4\textwidth]{figures/4-CybeleVarMag11.eps}}
...
\begin{figure}[!htbp]
  \centering
    ...
    \includegraphics[height=0.4\textwidth]{figures/4-CybeleProfileDenRadialeZ.eps}}
    \subfigure[]{\label{4-CybeleProfileTempRadialeZ}
    \includegraphics[height=0.38\textwidth]{figures/4-CybeleProfileTempRadialeZ.eps}}
...
\begin{figure}[!htbp]
  \centering
    ...
    \includegraphics[height=0.4\textwidth]{figures/4-CybeleCarteDensiteIsolant.eps}}
    \subfigure[]{\label{4-CybeleCartePotentielIsolant}
    \includegraphics[height=0.4\textwidth]{figures/4-CybeleCartePotentielIsolant.eps}}
    \subfigure[]{\label{4-CybeleCarteTemperatureIsolant}
    \includegraphics[height=0.4\textwidth]{figures/4-CybeleCarteTemperatureIsolant.eps}}
...
\begin{figure}[!htbp]
  \centering
    ...
    \includegraphics[height=0.48\textwidth]{figures/4-Tokam1.eps}}
    \subfigure[]{\label{4-Tokam2}
    \includegraphics[height=0.48\textwidth]{figures/4-Tokam2.eps}}
...
\begin{figure}[!htbp]
  \centering
    ...
    \includegraphics[height=0.38\textwidth]{figures/4-TokamProfileDensite.eps}}
    \subfigure[]{\label{4-TokamProfileFluxRadial}
    \includegraphics[height=0.38\textwidth]{figures/4-TokamProfileFluxRadial.eps}}
    \caption{Comparaison des profils de
...
\begin{figure}[!htb]
  \centering
    ...
    \includegraphics[height=0.35\textwidth]{figures/4-MagnisPDFDen.eps}}
    \subfigure[]{\label{4-TokamPDFDen}
    \includegraphics[height=0.35\textwidth]{figures/4-TokamPDFDen.eps}}
...
\begin{figure}[!htb]
  \centering
    ...
    \includegraphics[height=0.35\textwidth]{figures/4-MagnisPDFFlux.eps}}
    \subfigure[]{\label{4-TokamPDFFlux}
    \includegraphics[height=0.35\textwidth]{figures/4-TokamPDFFlux.eps}}
    \caption{PDF des fluctuations de
