...
dit ambipolaire qui les fait dériver ensemble. Le plasma d'hydrogène a une
densité de 3 10$\puissance{14}$ m$\puissance{-3}$ et sa température, assez
homogène, est de 11eV.
...
L'apparition d'un faible champ magnétique modifie radicalement la nature du
...
critique. A partir de 3G, la température maximale commence à osciller et
augmente plus modérément. Le rayon de Larmor passe alors sous la barre des 5cm
et le plasma se met en rotation, changeant encore de forme comme le montre la
figure~\ref{4-CybeleVarMag2}. Deux ilôts de densité plus élevée apparaissent,
tournant concentriquement à une vitesse angulaire $\Omega_r$ de  1.4
 rad/s sur une orbite de rayon approximativement égale au
rayon de Larmor électronique. A B=7.5G la fréquence cyclotronique électronique
est égale à 1.3 10$\puissance{8}\,\text{s}\puissance{-1}$, très proche de la fréquence de
collision des électrons. Le maximum de température atteint son plus taux de
fluctuation, 

Ce premier type de fonctionnement, qui est caractérisé par une
...
gauss. A 20G, le plasma est extrêmement instable, comme illustré sur la
figure~\ref{4-CybeleVarMag-2}.
