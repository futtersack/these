...
Ecrivons l'équation du mouvement comme une équation algébrique d'inconnue
$\mathbf u$, reliant la fréquence caractéristique du transport
$\omega\sim\partial_t$, une fréquence de collision effective $\nu_m$ et la
fréquence cyclotronique $\omega_c$ avec un terme
$\mathbf F$ accélérateur incluant le terme inertiel d'advection :
...
avec $\delta=\alpha_\omega/\Delta t+\omega_c$
