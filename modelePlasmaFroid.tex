...
\begin{figure}[!htbp]
    ...
    \includegraphics[width=0.32\textwidth]{figures/3-coeffColl1.eps}}
    \subfigure[]{\label{3-coeffColl2}
    \includegraphics[width=0.32\textwidth]{figures/3-coeffColl2.eps}}
    \subfigure[]{\label{3-coeffColl3}
    \includegraphics[width=0.32\textwidth]{figures/3-coeffColl3.eps}}
...
\frac{\partial k_e^\varepsilon}{\partial
T_e}\left(T_e^{k+1}-T_e^{k}\right)\right)
\end{split}
\end{equation}
