...
\begin{enumerate}
  ...
  $S_\alpha$ et des vitesses aux bords du domaine $u_{\alpha_\para}$.
  \item Prédiction des vitesses fluides $\tilde{\mathbf u}_\alpha$ par
  ...
  \item Correction des vitesses fluides $\mathbf u_\alpha$ pour le nouveau
  $\mathbf E$.
  \item Résolution des équations de continuité ioniques avec les vitesses
  corrigées $\mathbf u_\alpha$.
