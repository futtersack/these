...
\centering
    ...
    \captionof{figure}{Côté faible champ, la courbure et le gradient de densité
    sont opposés. L'interchange est instable~\parencite{SarazinPhD}.}
    \label{2-stable}
\end{minipage}
\end{minipage}
...
\subsection{Analyse linéaire de TOKAM anisotherme}
