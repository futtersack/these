...
\centering
    ...
    \caption{Densité de probabilité pour la densité et le flux radial. Les PDF
    sont normalisées par l'écrart entre le maximum et minimum de la quantité :
    $\Delta\chi=\chi_\text{max}-\chi_\text{min}.$}
    \label{2-PDFBase}
\end{figure}
