...
du courant diamagnétique, contient l'élément déstabilisant de
 l'instabilité d'interchange, dû au gradient de densité et à la courbure du
 champ magnétique.
...
Garbet détermine un coefficient de courbure $g$ moyen tel que :

\begin{equation}
\left<T_e(1+\tau)\left[n,B^{-1}\right]\right>_\para=g\partial_yn
\end{equation}

comme ce coefficient est positif, le signe du terme déstabilisant
de l'interchange $g\partial_yn$ ne dépend que du sens du gradient de densité,
donnant un caractère de ballooning à l'instabilité, ie. qui ne se développe que
...
&\partial_t n + \frac{nc_s}{L_\para}\exp(\Lambda-e\Delta U/T_e) =
\frac{1}{B}\left[n,U\right] + D_\perp\nabla^2_\perp n + S
\\\begin{split}
\label{2-eqCourantMoyenne}
&\frac{enc_s}{L_\para}\left(1-\exp(\Lambda-e\Delta U/T_e)\right) +
-g\partial_yn =\\
&\frac{nm_i}{B^2}\left(\partial_\text{t}W - \nu_\perp
\nabla_\perp^2W+
B\puissance{-1}\left[U,W\right]\right)
...
l'écriture des équations, les différents termes sont maintenant adimensionnées.
L'intensité du champ magnétique $B\indice{0}$ et à la température électronique
de référence $T\indice{0}$ constituent les bases de cet adimensionnement. Le
...
$\overline{\text{N}}$ et le potentiel électrostatique $\overline \Phi$ par :

\begin{eqnarray}
n = n_{\indice{0}}N & \text{et} & U=\frac{\Phi T\indice{0}}{e}
\end{eqnarray}
...
\nabla_\perp^2W+
\left[\Phi,W\right] =
\sigma\left(1-e^{\Lambda-\Delta\Phi}\right)-g\partial_y\log N
\end{align}

Dans cette expression, l'équation de vorticité a de plus été divisée par la
densité. Le champ magnétique et la température électronique sont pris constants
et uniformes $\overline{B}=\overline{T_e}=1$ et les termes de diffusion
$D_\perp/D_B=D$ et de viscosité $\nu_\perp/D_B=\nu$ sont normalisés au
coefficient de Bohm $D_B=\rho_ic_s^2$.
Nous interprétons enfin $\sigma\sim\rho_i/L_\para$ comme la conductivité de
gaine. Du fait de sa faible valeur, elle limite les pertes en courant parallèle
au niveau des parois (limiteur), et laissant ainsi l'instabilité se développer. 
