...
(ceci pouvant éventuellement être modifié, cf. partie~\ref{vitessesDerivePlasmaFroid}).
...
\end{itemize}
	...
	gaines prédise le même comportement dans le cas des plasmas froids et que dans celui des plasmas magnétiséw le long des lignes de 
