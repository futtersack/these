...
\begin{figure}[!htbp]
    ...
    pointillé et l'écart type apparaît en coulour plus foncée.}
    \label{2-PDFBase}
\end{figure}
...
importants, de 3 à 4 fois l'écart type, peuvent apparaître. Bien que
les avalanches donnent l'impression d'un transport radial
...
requiert une réécriture plus en profondeur du modèle, ce qui sera l'objet de la
partie suivante.
