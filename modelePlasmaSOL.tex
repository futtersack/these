...
\begin{figure}[!htbp]
    ...
    \includegraphics[height=0.4\textwidth]{figures/2-CarteDensiteBase.eps}}
    \subfigure[]{\label{2-CartePotentielBase}
    \includegraphics[height=0.4\textwidth]{figures/2-CartePotentielBase.eps}}
...
\begin{figure}[!htbp]
    ...
    \includegraphics[height=0.35\textwidth]{figures/2-TokamPDFDensite.eps}}
    \subfigure[]{\label{2-TokamPDFFlux}
    \includegraphics[height=0.35\textwidth]{figures/2-TokamPDFFlux.eps}}
...
\begin{figure}[!htbp]
    ...
    \includegraphics[height=0.38\textwidth]{figures/2-CarteDensiteMagBarrier.eps}}
    \subfigure[]{\label{2-CartePotentielMagBarrier}
    \includegraphics[height=0.38\textwidth]{figures/2-CartePotentielMagBarrier.eps}}
...
\begin{figure}[!htbp]
    ...
    \includegraphics[height=0.4\textwidth]{figures/2-magBarrierDenProfil.eps}}
    \subfigure[]{\label{2-magBarrierFlucProfil}
    \includegraphics[height=0.4\textwidth]{figures/2-magBarrierFluctProfil.eps}}
...
\begin{figure}[!htbp]
    ...
    \includegraphics[height=0.39\textwidth]{figures/2-CarteDensiteWhTe.eps}}
    \subfigure[]{\label{2-CartePotentielWithTe}
    \includegraphics[height=0.39\textwidth]{figures/2-CartePotentielWhTe.eps}}
    \subfigure[]{\label{2-CarteTeWhTe}
    \includegraphics[height=0.39\textwidth]{figures/2-CarteTeWhTe.eps}}
...
\centering
    ...
    \includegraphics[height=0.4\textwidth]{figures/2-CartePotentielSurTeWhTedNdx.eps}}
	\subfigure[]{\label{2-ProfileFluxWhTe}
    \includegraphics[height=0.38\textwidth]{figures/2-profileFluxRadialWhTedNdx.eps}}
...
précédemment ; il est dû là aussi aux conditions aux limites transverses.
    ...
    \includegraphics[height=0.39\textwidth]{figures/2-CarteDensiteMagBarrierWhTe.eps}}
    \subfigure[]{\label{2-CartePotentielMagBarrierWhTe}
    \includegraphics[height=0.39\textwidth]{figures/2-CartePotentielMagBarrierWhTe.eps}}
    \subfigure[]{\label{2-CarteTeMagBarrierWhTe}
    \includegraphics[height=0.39\textwidth]{figures/2-CarteTeMagBarrierWhTe.eps}}
...
champ, court-circuitant le transport perpendiculaire.
 ...
 \begin{figure}[!htbp]
    ...
    \includegraphics[height=0.39\textwidth]{figures/2-CarteDensiteMagColumn.eps}}
    \subfigure[]{\label{2-CartePotentielMagColumn}
    \includegraphics[height=0.39\textwidth]{figures/2-CartePotentielMagColumn.eps}}
    \subfigure[]{\label{2-CarteTeMagColumn}
    \includegraphics[height=0.39\textwidth]{figures/2-CarteTeMagColumn.eps}}
