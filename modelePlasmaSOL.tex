...
avalanche. Il a aussi permi de prouver le déclenchement à seuil de
l'instabilité.
...
Debye $\lambda_D$, de l'ordre de 10$^{-5}$~m, ce qui permet de
...
électronique $n=n_e$ et du potentiel électrostatique $U$ en résolvant l'équation
...
particule. L'hypothèse flûte, qui autorise la réduction du problème de trois à
deux dimensions, consiste à considérer les fluctuations constantes le long des
lignes de champ.
...
\cite{SarazinPhD} pour simplifier le modèle. Elles conduisent à l'expression
