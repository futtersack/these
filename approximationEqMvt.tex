...
principaux outils de la science moderne, et, grâce aux méthodes numériques, nous
...
Actuellement, les modèles les plus complets pour décrire un plasma sont sans
...
qui donnent un accès plus direct aux mécanismes de transport. En fonction des
...
Communément retenue dans le domaine des plasmas froids, la première hypothèse
pour simplifier l'équation de la quantité de mouvement consiste à considérer le
...
ceux résultants de la viscosité. L'équation de la
quantité de mouvement~\eqref{1-eqMouvement} se réduit ainsi à un équilibre entre les forces
...
transport, i.e. $\omega_{ce},\omega_{ci}\gg\omega$. 
