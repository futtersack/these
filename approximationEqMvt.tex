...
en incluant le terme de collision dans l'expression de la vitesse, mais
on ne sait plus trop à quoi correspond le petit paramètre $\epsilon_\omega$ ni
si un développement en ordres successifs de $\epsilon_\omega$ a encore un
sens.
...
coefficients de transport. La prise en compte des termes d'inertie demande par
contre un nouveau formalisme pour la dérivation du modèle, qui ne décrit plus
